...
int main()
{
  ...
  std::shared_ptr<WaterAsset> riverWater =
      std::make_shared<WaterAsset>("river", 14.0, "river blue");
  ...
  std::shared_ptr<GrassAsset> meadowGrass =
      std::make_shared<GrassAsset>("meadow", 14.0, "meadow green");
